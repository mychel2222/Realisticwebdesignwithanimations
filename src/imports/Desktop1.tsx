import svgPaths from "./svg-ubzjqwpxg9";
...
export default function Desktop() {
  return (
    <div className="bg-gradient-to-b border border-[#f04438] border-solid from-[#fd9b9b] relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] size-full to-[#fee4e2]" data-name="Desktop - 1">
      <div className="absolute h-[633px] left-[169px] pointer-events-none rounded-[20px] top-[151px] w-[1106px]" data-name="image 5">
      ...
      <div className="absolute h-[127px] left-[664px] top-[190px] w-[115px]" data-name="image 4">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage4} />
      </div>
      <div className="absolute font-['Inter:Bold',sans-serif] font-bold h-[164px] leading-[72px] left-[270px] not-italic text-[60px] text-white top-[354px] tracking-[-1.2px] w-[1040px]">
        <p className="mb-0 whitespace-pre-wrap">{`    KOMISI PEMILIHAN UMUM`}</p>
        <p>KABUPATEN PAK PAK BHARAT</p>
      </div>
      <div className="absolute h-[60px] left-[483px] top-[607px] w-[164px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 164 60">
          <path d={svgPaths.p23e9b900} fill="var(--fill-0, #D9D9D9)" id="Rectangle 1" stroke="var(--stroke-0, #FFA2A2)" />
        </svg>
      </div>
      <div className="absolute h-[60px] left-[790px] top-[607px] w-[164px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 164 60">
          <path d={svgPaths.p23e9b900} fill="var(--fill-0, #D9D9D9)" id="Rectangle 1" stroke="var(--stroke-0, #FFA2A2)" />
        </svg>
      </div>
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[511px] not-italic text-[#e04d4d] text-[16px] text-nowrap top-[627px] whitespace-pre">LIHAT BERITA</p>
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[843px] not-italic text-[#db4a4a] text-[16px] text-nowrap top-[627px] whitespace-pre">PROFIL</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-[751px] not-italic text-[18px] text-black text-nowrap top-[64px] whitespace-pre">TENTANG</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-[903px] not-italic text-[18px] text-black text-nowrap top-[64px] whitespace-pre">BERITA</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-[1030px] not-italic text-[18px] text-black text-nowrap top-[64px] whitespace-pre">PUBLIKASI</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-[1191px] not-italic text-[18px] text-black text-nowrap top-[64px] whitespace-pre">KONTAK</p>
      <div className="absolute h-[27px] left-[1305px] pointer-events-none rounded-[2px] top-[calc(50%-1165px)] translate-y-[-50%] w-[24px]" data-name="Search">
      ...
      <div className="absolute flex h-[11px] items-center justify-center left-[844px] top-[71px] w-[12px]" style={{ "--transform-inner-width": "11", "--transform-inner-height": "12" } as React.CSSProperties}>
      ...
      <div className="absolute flex h-[11px] items-center justify-center left-[1269px] top-[71px] w-[12px]" style={{ "--transform-inner-width": "11", "--transform-inner-height": "12" } as React.CSSProperties}>
        <div className="flex-none rotate-[270deg]">
          <div className="h-[12px] relative w-[11px]" data-name="Back">
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none size-full" src={imgBack} />
          </div>
      ...
      <div className="absolute flex h-[11px] items-center justify-center left-[1129px] top-[71px] w-[12px]" style={{ "--transform-inner-width": "11", "--transform-inner-height": "12" } as React.CSSProperties}>
        <div className="flex-none rotate-[270deg]">
          <div className="h-[12px] relative w-[11px]" data-name="Back">
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none size-full" src={imgBack} />
          </div>
      ...
      <div className="absolute flex h-[11px] items-center justify-center left-[968px] top-[71px] w-[12px]" style={{ "--transform-inner-width": "11", "--transform-inner-height": "12" } as React.CSSProperties}>
        <div className="flex-none rotate-[270deg]">
          <div className="h-[12px] relative w-[11px]" data-name="Back">
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none size-full" src={imgBack} />
          </div>
      ...
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[32px] left-[202px] not-italic text-[24px] text-black text-nowrap top-[1625px] whitespace-pre">{`BERITA TERKINI `}</p>
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[32px] left-[178px] not-italic text-[24px] text-black text-nowrap top-[2070px] whitespace-pre">{`     PENGUMUMAN `}</p>
      <div className="absolute bg-[#fef3f2] h-[220px] left-[198px] top-[2116px] w-[1062px]" />
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[600px] not-italic text-[#2b2b2b] text-[16px] text-nowrap top-[2199px] whitespace-pre">---Link cepat---</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[600px] not-italic text-[#2b2b2b] text-[16px] text-nowrap top-[2229px] whitespace-pre">---Link cepat---</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[600px] not-italic text-[#2b2b2b] text-[16px] text-nowrap top-[2259px] whitespace-pre">---Link cepat---</p>
      <div className="absolute left-[918px] size-[26px] top-[2183px]" data-name="image 8">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage8} />
      </div>
      <div className="absolute h-[26px] left-[966px] top-[2183px] w-[30px]" data-name="image 9">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage9} />
      </div>
      <div className="absolute flex items-center justify-center left-[1016px] size-[28px] top-[2181px]">
      ...
      <div className="absolute bg-[#fef3f2] border border-[#581313] border-solid h-[290px] left-[209px] top-[1683px] w-[220px]" />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[268px] not-italic text-[#b54545] text-[14px] top-[1936px] w-[119px]">Selengkapnya...</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[535px] not-italic text-[#b54545] text-[14px] top-[1934px] w-[119px]">Selengkapnya...</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[851px] not-italic text-[#b54545] text-[14px] top-[1936px] w-[119px]">Selengkapnya...</p>
      ...
      <div className="absolute h-[112px] left-[238px] rounded-[15px] top-[1702px] w-[167px]" data-name="image 11">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[15px] size-full" src={imgImage11} />
      </div>
      <div className="absolute bg-[#fef3f2] border border-[#581313] border-solid h-[290px] left-[776px] top-[1683px] w-[220px]" />
      ...
      <div className="absolute h-[112px] left-[805px] rounded-[15px] top-[1702px] w-[167px]" data-name="image 20">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[15px] size-full" src={imgImage11} />
      </div>
      <div className="absolute h-[38px] left-[1345px] top-[58px] w-[33px]" data-name="Menu">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none size-full" src={imgMenu} />
      </div>
      <div className="absolute bg-[#eaecf0] border border-[#dc6803] border-solid h-[507px] left-[181px] rounded-[42px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[911px] w-[1112px]" />
      ...
      <div className="absolute h-[358px] left-[737px] rounded-[45px] top-[986px] w-[526px]" data-name="image 12">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[45px] size-full" src={imgImage12} />
      </div>
      ...
      <div className="absolute bg-[#ffdddd] border border-[#b8312c] border-solid h-[48px] left-[355px] rounded-[12px] top-[1331px] w-[179px]" />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[444.5px] not-italic text-[#ec9090] text-[16px] text-center text-nowrap top-[1345px] translate-x-[-50%] whitespace-pre">Selengkapnya..</p>
